...
const ResultCardShowFlag = {
  type: "DAO", // Project,Bounty,DAO,User,discordChannel
  picture: true,
  description: true,
  skills: true,
  generalTags: true,
...
const Result = [
  {
    ...
    name: "bluePanda",
    matchingSkills: ["Typescript", "Javascript", "React", "Angular", "Jira"],
    edenMembersDAO: "45",
    edenMembersDAOPictures: [
    ...
    missingSkills: ["Typescript", "Javascript", "React", "Angular", "Jira"],
  },
  {
    description: "asdf",
    percentage: "75%",
