...
export const PopoverWithHover: FC<PopoverWithHoverProps> = ({ children }) => {
          ...
          return (
            <>
              <div onMouseLeave={onMouseLeave.bind(null, open)}>
                ...
                >
                  <Popover.Panel className="absolute left-1/2 z-10 mt-0 w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
                    <div
